...
The dashboard focuses on answering three key business questions:

What happened? → Executive Overview
Why did it happen? → Profitability Analysis
What should we do next? → Expansion Strategy
...
The project uses simulated business transaction data across 10,000 orders covering:
...
KPIs
Total Revenue → ₹232.59M
Total Profit → ₹35.01M
Profit Margin → 15.05%
Total Orders → 10,000
Average Order Value → ₹23,259
Top Profit City → Mumbai
Key Insights
Chennai generated highest revenue
...
Fashion category underperformed
Higher discounting negatively impacted margins
Business Insight
...
Invest aggressively in Mumbai & Chennai
Expand in Pune & Hyderabad
Optimize pricing strategy in Delhi
Monitor Noida & Kolkata
Prioritize high-margin expansion markets
Business Impact
